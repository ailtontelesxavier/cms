      ...
      <div class="rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          <div>
            ...
            <input id="email" v-model="email" type="email" required autocomplete="email" :disabled="mfaRequired"
              class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 disabled:bg-gray-100" />
          </div>

          <div>
            <label for="password" class="block text-sm font-medium text-gray-700">Senha</label>
            <input id="password" v-model="password" type="password" required autocomplete="current-password" :disabled="mfaRequired"
              class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-sky-500 focus:outline-none focus:ring-1 focus:ring-sky-500 disabled:bg-gray-100" />
          </div>
